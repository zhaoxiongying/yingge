...
public class AnswerParam {
     ...
     * @mbg.generated
     */
    public AnswerParam appendOrderByClause(OrderCondition orderCondition, SortType sortType) {
     ...
     * @mbg.generated
     */
    public AnswerParam setPage(boolean page) {
        this.page = page;
        return this;
    }
     ...
     * @mbg.generated
     */
    public AnswerParam setPageSize(int pageSize) {
     ...
     * @mbg.generated
     */
    public AnswerParam setPageStart(int pageStart) {
     ...
     * @mbg.generated
     */
    public AnswerParam appendDistinct(OrderCondition condition) {
        if (null != distinctSql){
