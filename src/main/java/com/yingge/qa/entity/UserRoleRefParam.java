...
public class UserRoleRefParam {
     ...
     * @mbg.generated
     */
    public UserRoleRefParam appendOrderByClause(OrderCondition orderCondition, SortType sortType) {
     ...
     * @mbg.generated
     */
    public UserRoleRefParam setPage(boolean page) {
        this.page = page;
        return this;
    }
     ...
     * @mbg.generated
     */
    public UserRoleRefParam setPageSize(int pageSize) {
     ...
     * @mbg.generated
     */
    public UserRoleRefParam setPageStart(int pageStart) {
     ...
     * @mbg.generated
     */
    public UserRoleRefParam appendDistinct(OrderCondition condition) {
        if (null != distinctSql){
